...
unlocked to sign the Ecurrency-Qt.app bundle.
...
allowing somebody to distribute a Ecurrency-Qt.app or bitcoin-qt-setup.exe with a valid
...
that the ecurrency-qt.exe file inside the installer had not been tampered with.
